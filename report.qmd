...
# verify convergence among the chains
...
In this simulation, post-discharge care management is associated with a 30% reduced odds ($\frac{P(Y=1)}{P(Y=0)}$) of readmission.  