...
The [simulated data](https://github.com/davechilders/post-discharge-intervention-analysis/blob/main/02-data-simulation-clean.R) for this analysis incorporates many of these characteristics.
